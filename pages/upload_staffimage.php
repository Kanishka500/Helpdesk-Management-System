        ...
        <div id="main_content">
            ...
            <div id="heding_section">
                <!--------------------heding_section----------------------------->
                <h1 class="txt_t1">Add System Staff to System </h1>
                <h2 class="font_txt">Step 2 Select Profile Image</h2>

                <ul class="breadcrumb">
                    <li><a href="#">Home</a></li>
                    <li><a href="#">Add System Staff</a></li>
                    <li><a href="#">Select Profile Imag</a></li>
                    <li>Profile Imag</li>
                </ul>
                <!--------------------heding_section----------------------------->
            </div>
            <div id="body_section">
                ...
                <div class="div_section">
                    <h1 class="txt_t2">Add System Staff Form</h1>
                            ...
                            <div class="upload_defult">
                                ...
                                <form action="" method="POST" onSubmit="return sendData();">
                                    ...
                                    <div id="defult_colum1">
                                        ...
                                        ?>
                                        <button name="submit" onClick="sendData();" class="buttonimage"><i class="fas fa-tags"></i>Save Profile Image</button>
                                    </div>
                                </form>
                                <div id="defult_colum1">
