...
if (isset($_POST['file_name'])) {
    ...
    //----------------get image------------------------------
    $sql = "SELECT user_image FROM user_infor WHERE user_id=:userid";
    ...
    if ($file_uploaded) {
        ...
        if (!empty($result)) {
            ...
            $pdo = null;
            header("location:index.php?page=manage_staff&pn=" . $pag . "&setid=" . $setid);
        } else {
...
if (isset($_POST['defimg'])) {
    ...
    if (!empty($result)) {
        ...
        echo '<label class="messadd">Not successfuly.Try Agin</label>';
    }
}
?>
<!DOCTYPE html>
...
<head>
    ...
    <link href="css/edit_staffimage.css" rel="stylesheet" />
